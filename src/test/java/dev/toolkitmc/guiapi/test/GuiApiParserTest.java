...
import dev.toolkitmc.guiapi.modmenu.GuiApiModMenuEntry;
...
public class GuiApiParserTest {
    ...
    public void testParseActionFromString() {
        ...
        GuiDefinition.ButtonAction action1 = GuiApiModMenuEntry.parseActionFromString("close");
        assertNotNull(action1);
        assertEquals(GuiDefinition.ActionType.CLOSE, action1.type());

        // Test message action
        GuiDefinition.ButtonAction action2 = GuiApiModMenuEntry.parseActionFromString("message:Hello World!");
        assertNotNull(action2);
        assertEquals(GuiDefinition.ActionType.MESSAGE, action2.type());
        assertEquals("Hello World!", action2.value());

        // Test set_var action
        GuiDefinition.ButtonAction action3 = GuiApiModMenuEntry.parseActionFromString("set_var:count:42");
    ...
    public void testSerializeActionsToString() {
        ...
        String serialized = GuiApiModMenuEntry.serializeActionsToString(actions);
